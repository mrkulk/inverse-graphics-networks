...
function INTM:updateGradInput(input, gradOutput)
  ...
  for i=1,bsize do
    self.gradInput[i][1] = torch.sum(torch.cmul(gradOutput_reshaped[{i,{},{}}], grad_s1[{i,{},{}}]))
    self.gradInput[i][2] = torch.sum(torch.cmul(gradOutput_reshaped[{i,{},{}}], grad_s2[{i,{},{}}]))
    self.gradInput[i][3] = torch.sum(torch.cmul(gradOutput_reshaped[{i,{},{}}], grad_t1[{i,{},{}}]))
    self.gradInput[i][4] = torch.sum(torch.cmul(gradOutput_reshaped[{i,{},{}}], grad_t2[{i,{},{}}]))
