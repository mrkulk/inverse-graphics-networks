...
function ACR:updateGradInput(input, gradOutput)
  ...
  for output_x = 1, self.output:size()[1] do
    for output_y = 1, self.output:size()[2] do
      ...
      self.gradTemplate[{{x_low, x_high}, {y_low, y_high}}]:addr(x_vec, y_vec)
